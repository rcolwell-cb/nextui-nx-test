...
- **accordion:** framer motion added to animate the open/close transitions
...
- warning keys accordion

- update accordion on child change
...
- update accordion item heading tag to be customizable
...
- **accordion:** hide indicator prop in accordion item

- **accordion:** accordion is no longer preventing spacebar

- **accordion:** selectedKeys added to the values memo function
...
- **components:** accordion component throws "validateDOMNesting" erro…

- **accordion:** remove dividers from hidden accordion items
...
- Updated @nextui-org/use-aria-accordion to 2.2.0
