...
- fixed modal button press issue

- moved sr only modal close buttons to not show unnecessary scroll bar

- add peer dependencies

- plop template error

- #2382 typo in modal transition CSS variable access
...
- **modal:** content when no animated
...
- **modal:** input carry over with IMEs in modal forms

- **modal:** inside and outside scroll
...
- Updated @nextui-org/use-aria-modal-overlay to 2.2.0
