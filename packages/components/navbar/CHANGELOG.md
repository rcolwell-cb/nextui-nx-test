...
- **docs:** mobile improvements, new section added
...
- fixed navbar link problems in docs
...
- **docs:** navbar examples

- **navbar:** unable to Close NavbarMenu

- **navbar-menu:** dismiss buttons removed to fix the scroll
...
- **navbar:** lazy motion forwardRef issue
...
- Updated @nextui-org/use-aria-toggle-button to 2.2.0
- Updated @nextui-org/use-scroll-position to 2.2.0
